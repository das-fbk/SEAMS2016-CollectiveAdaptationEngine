...
public class Utilities {
	...
	staticMap.put("I1", new String[] { "C1", "H1", "D1", "D2", "D5", "H3", "H2", "D3", "D4" });
	staticMap.put("I2", new String[] { "H1", "D1", "D2", "D5", "H3", "H2", "D3", "D4" });
	staticMap.put("I3", new String[] { "D1", "D2", "C1", "H1", "D5", "H3", "D3", "D4", "H2" });
	staticMap.put("I4", new String[] { "D1", "D2", "D5", "D3", "D4" });
	staticMap.put("I5", new String[] { "H1", "H2", "H3" });
	staticMap.put("I6", new String[] { "H1", "H2", "H3" });
	staticMap.put("I7", new String[] { "H1", "H2", "H3" });
	staticMap.put("I8", new String[] { "H1", "H2", "H3" });
	staticMap.put("I9", new String[] { "H1", "H2", "H3" });
	staticMap.put("I10", new String[] { "H1", "H2", "H3" });
	// staticMap.put("I11", new String[] { "G1" });
	staticMap.put("I12", new String[] { "H1", "H2", "H3" });
	staticMap.put("I13", new String[] { "H1", "H2", "H3" });
	// staticMap.put("I14", new String[] { "CS" });
	// staticMap.put("I15", new String[] { "M1", "M2", "M3" });
	staticMap.put("I18", new String[] { "M2", "M1", "M3" });

	Utilities.solversMap = new HashMap<String, ArrayList<RoleManager>>();
	Utilities.solversMap.put("I1", new ArrayList<RoleManager>());
